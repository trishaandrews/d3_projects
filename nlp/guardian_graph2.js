...
/* .......................................................................... */
  ...
  var force = d3.layout.force()
    //.charge(-320)
    .size( [WIDTH, HEIGHT] )
    //.linkStrength( function(d,idx) { return d.value; } );
    .linkDistance(2)
    .linkStrength(1);
  ...
  //var svg = d3.select("#guardianNetwork").append("svg:svg")
  ...
  *//*
  ...
  d3.json( 'all_nodeslinks.json', function(error, data) {
    ...
    minLinkValue = 
      Math.min.apply( null, links.map( function(n) {return n.value;} ) );
    maxLinkValue = 
      Math.max.apply( null, links.map( function(n) {return n.value;} ) );
    ...
    var node_size = d3.scale.linear()
      .domain([0,800])	// we know score is in this domain
      .range([1,20]);
      //.clamp(true);
    var edge_width = 1;//d3.scale.pow().exponent(8)
    ...
    var graphLinks = networkGraph.append('svg:g').attr('class','grp gLinks')
      ...
      //.enter().append("line")
      .style('stroke-width', function(d) { return edge_width;} )
      //.attr("class", "link");
      .enter().append("path")
      .attr("class", "link");
      /*
